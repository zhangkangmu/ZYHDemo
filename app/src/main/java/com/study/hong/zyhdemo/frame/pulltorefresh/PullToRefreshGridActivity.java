 ...
 *******************************************************************************/
package com.study.hong.zyhdemo.frame.pulltorefresh;
...
public final class PullToRefreshGridActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pull_refresh_activity_ptr_grid);
	...
	private class GetDataTask extends AsyncTask<Void, Void, String[]> {
		...
		protected void onPostExecute(String[] result) {
			mListItems.addFirst("这是PullToRefreshGridActivity...");
	...
	private String[] mStrings = { "PullToRefreshGridActivity数据","PullToRefreshGridActivity数据" };
}
